 ...
 *   
 * 
 * Die Version der UltraTouch SX (Version 6) ist ausgestattet mit einem Nextion 
 * Display und sie versendet MIDI zur Nutzung der Räuspertasten. Sie kann vielseitig 
 * genutzt und erweitert werden ;)
 * 
 * Diese Projekt entstand im Rahmen des Ultraschall Projektes zum Themea: 
 * “MIDI Controller". Es gibt viele weitere Projekte von meinen Kollegen 
 * und der Community. Schau doch mal vorbei: https://ultraschall.fm
 * 
